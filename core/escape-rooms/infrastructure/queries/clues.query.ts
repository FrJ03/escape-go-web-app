...
const DELETE_CLUES_BY_ESCAPE_ROOM = 'DELETE FROM clues WHERE escape_room = $1;'

export {INSERT_CLUE, GET_CLUE_BY_ID, GET_ALL_CLUES_BY_ESCAPE_ROOM, DELETE_CLUES_BY_ESCAPE_ROOM}